...
# Test
python ensamble.py --batch_size 30 --save $EXPERIMENT$TARGET --use_gpu --conv_encode_edge --balanced_loader --nclasses 8 --lr 5e-3 --num_layers 25 --hidden_channels 256 --num_features 8 --learn_t
